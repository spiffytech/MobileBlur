...
response.meta.author = 'spiffytech'
response.meta.description = 'Mobile-friendly interface for the Newsblur RSS reader'
response.meta.keywords = 'mobileblur,newsblur,mobile rss'
